--1-- making primary key unique and not null
--2-- removing not important spaces by trim function
--3-- Changing marital_status to married and single through case when 
--	  upper is making all of them capital to prevent small letters errors
--	  trim for space removal
--4-- insert into silver schema table
/*
	*************************** silver.crm_cust_info "Transformation"*******************************
*/ 
